...
func (q *Queries) AddSessionMember(ctx context.Context, arg AddSessionMemberParams) error {
	_, err := q.db.Exec(ctx, addSessionMember,
		arg.OrgID,
		arg.SessionID,
		arg.AccountID,
		arg.Role,
...
func (q *Queries) GetSessionMember(ctx context.Context, arg GetSessionMemberParams) (SessionMember, error) {
	row := q.db.QueryRow(ctx, getSessionMember, arg.OrgID, arg.SessionID, arg.AccountID)
	var i SessionMember
	err := row.Scan(
		&i.OrgID,
		&i.SessionID,
...
func (q *Queries) ListSessionMembers(ctx context.Context, arg ListSessionMembersParams) ([]SessionMember, error) {
	rows, err := q.db.Query(ctx, listSessionMembers, arg.OrgID, arg.SessionID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListSessionMembershipsForAccount(ctx context.Context, accountID string) ([]ListSessionMembershipsForAccountRow, error) {
	rows, err := q.db.Query(ctx, listSessionMembershipsForAccount, accountID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RemoveSessionMember(ctx context.Context, arg RemoveSessionMemberParams) error {
	_, err := q.db.Exec(ctx, removeSessionMember, arg.OrgID, arg.SessionID, arg.AccountID)
	return err
}
