...
CREATE TABLE sessions (
    ...
    last_substantive_activity_at DATETIME,  -- NOT NULL for new rows; nullable only for pre-migration rows
    hard_cap_at DATETIME,                   -- nullable; set only for playground sessions
    idle_timeout_at DATETIME                -- nullable; set only for playground sessions
);
